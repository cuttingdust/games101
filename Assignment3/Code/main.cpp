...
Eigen::Vector3f phong_fragment_shader(const fragment_shader_payload &payload) {
  ...
  // Clamp the final color to the range [0, 255] and convert to byte
...
Eigen::Vector3f displacement_fragment_shader(const fragment_shader_payload &payload) {
  ...
  float dU, dV;
  dU = kh * kn * (payload.texture->getColorBilinear(u + 1.f / w, v).norm() - payload.texture->getColorBilinear(u, v).norm());
  dV = kh * kn * (payload.texture->getColorBilinear(u, v + 1.f / h).norm() - payload.texture->getColorBilinear(u, v).norm());
...
//  std::string obj_path = "../models/spot/";
  std::string obj_path = "/Users/handabao/Downloads/GAMES101_作业/games101/Assignment3/Code/models/cube/";
